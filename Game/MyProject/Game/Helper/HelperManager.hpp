...
namespace HelperManager
{
    ...
    std::shared_ptr<SceneNode> BuildTexturedQuad(const std::shared_ptr<MeshInstance>&,const char* textureName,const char* shaderName="TextureShader",IvVector3 axis=IvVector3::zAxis,bool depth=true,bool blend=true, bool wireframeValue=false);
