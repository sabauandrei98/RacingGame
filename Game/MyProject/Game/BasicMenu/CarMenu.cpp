...
CarMenu::CarMenu()
{
    ...
    std::shared_ptr<SceneNode> backQuad=HelperManager::BuildTexturedQuad("backCar",HelperManager::CreateMeshInstance(meshManager.GetMesh("quad"),uniforms,"../../Game/BasicMenu/Shaders/AlphaChanger"),"tr_back.tga");
