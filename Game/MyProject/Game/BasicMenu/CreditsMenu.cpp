...
CreditsMenu::CreditsMenu()
{
    ...
    std::shared_ptr<SceneNode> backQuad=HelperManager::BuildTexturedQuad("backCredits",HelperManager::CreateMeshInstance(meshManager.GetMesh("quad"),uniforms,"../../Game/BasicMenu/Shaders/AlphaChanger"),"tr_back.tga");
