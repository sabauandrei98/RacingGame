...
ChooseTrackMenu::ChooseTrackMenu()
{
    ...
    std::shared_ptr<SceneNode> backQuad=HelperManager::BuildTexturedQuad("backChooseTrack",HelperManager::CreateMeshInstance(meshManager.GetMesh("quad"),uniforms,"../../Game/BasicMenu/Shaders/AlphaChanger"),"tr_back.tga");
